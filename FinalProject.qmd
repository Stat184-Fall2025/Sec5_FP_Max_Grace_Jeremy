...
This project uses the countryData dataset from the dcData package to conduct an exploratory data analysis of countries’ attributes such as population, education, public health, and macroeconomic conditions.
...
library(tibble)
library(dcData)
summary_tbl <- CountryData %>%
  select(
    area, pop, growth, birth, death,
    health, obesity, educ, unemployment, life
  ) %>%
  psych::describe()
...
img <- readJPEG("/Users/gracerovinsky/Downloads/WorldMap.jpg")
...
continents <- read_excel("/Users/gracerovinsky/Downloads/CountryByContinent.xlsx") %>%
